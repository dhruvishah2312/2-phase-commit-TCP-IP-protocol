...
public class Client_Participant3 {
    ...
    static class ChatAccess extends Observable {
        ...
        public void InitSocket(String server, int port) throws IOException {
            ...
            outputStream.write(("Participant_3\n").getBytes());
            outputStream.flush();
    		...
    		try {
    			if((line = br.readLine()) != null) {
    				...
    				while((line = br.readLine()) != null) {
    					textArea.append("File Content: " + line);					//Store the list in an array
    				}
    			} else {
        ...
        public void phaseCommit(String action) {
        	...
        	if(reply != null) {							//Perform write to file or don't depending on the coordinator decision
        		if(reply.contains("GLOBAL_COMMIT")) {
                	...
                	try {
						FileWriter writer = new FileWriter(new File("Participant_3.txt"));
